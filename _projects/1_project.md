...
<ul>
  ...
  <li>When the node metadata offer valuable insights, our models identify communities that align with this information. This approach leads to more interpretable results, where attributes actively influence the inference process, rather than only serving as a posterior tool for evaluating node partitions.</li>
</ul>
